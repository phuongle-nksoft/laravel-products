...
class Products extends NksoftModel
{
    ...
    protected $fillable = ['id', 'name', 'categories_id', 'vintages_id', 'regions_id', 'brands_id', 'is_active', 'order_by', 'price','alcohol_content', 'volume', 'description', 'slug', 'meta_description'];
